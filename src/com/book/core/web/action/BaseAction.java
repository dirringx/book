package com.book.core.web.action;
...
import com.book.core.exception.BaseAppRuntimeException;
 ...
 * 合适的方法.例如：如下请求字符串:xxx.action?method=delete，那么该Action就会根据method
 * 的值为delete调用delete()方法进行业务处理. <br/>
 * <b>注意：<b>method是硬编码的，在编程过程中需注意这点.
 * <ul>
 * *
 ...
 * </p>
 * <p>
 * <code> http://localhost:8080/myapp/saveSubscription.action?method=update
 * </code>
 * </p>
...
public abstract class BaseAction extends ActionSupport {
	...
	private String dispatchMethod(String name) throws Exception {
		...
		try {
			...
			String message = this.getMessage("dispatch.nosuchmethod", new String[] { name });
	...
	/**
	 * 当method为null时，表示方法没有指派，默认情况下回抛出异常.<br/>
	 * 对于子类可以重写该方法，自定义当方法没有指定时的行为.
	 * 
	 * @throws Exception
	 *             如果系统出现异常则抛出.
	 */
	 ...
	 * @param args
	 *            参数占位数组，例如：'app.title=nihao,{0},how are you,{1}' <br/>
	 *            args中的args[0]和args[1]分别替代{0},{1}。
	 * @param defaultMessage
	 *            找不到信息是，返回默认信息。
	 * @return 返回国际化信息
	 */
	protected String getMessage(String code, String[] args, String defaultMessage) {
